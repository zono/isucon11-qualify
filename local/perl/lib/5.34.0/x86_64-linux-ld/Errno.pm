...
"x86_64-linux-ld-5.4.0-1045-aws" or
	die "Errno architecture (x86_64-linux-ld-5.4.0-1045-aws) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
